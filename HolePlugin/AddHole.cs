...
namespace HolePlugin
{
    ...
    public class AddHole : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            Transaction transaction0 = new Transaction(arDoc, "Create holes");
            transaction0.Start();
            ...
            ReferenceIntersector referenceIntersector = new ReferenceIntersector(
                                                        ...
                                                        view3D);
            Transaction transaction = new Transaction(arDoc, "Create holes");
            transaction.Start();
            ...
            foreach  (Duct d in ducts)
            {
                ...
                List<ReferenceWithContext> intersections = referenceIntersector.Find(point, direction)
                    ...
                    .ToList(); //получили коллекцию всех пересечений вида ReferenceWithContext
